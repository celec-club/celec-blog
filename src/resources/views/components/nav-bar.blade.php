<nav class="navbar navbar-light navbar-expand-md navigation-clean" style="width: 100%;">
	<div class="container-fluid container-fluid" style="width: 100% !important;"><a href="{{  url('/') }}"><img src="{{ url('storage/app/img/celec_bleu-removebg-preview.png') }}" style="width: 64px;"></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
